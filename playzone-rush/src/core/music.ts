...
export const THEMES: Record<string, MusicTheme> = {
  ...
  // Acecho: pocas notas, mucho aire. Para buscar sin que la musica te empuje.
  caza: {
    bpm: 112,
    root: 45,
    ...
    snare: [8],
    hat: [4, 12],
    bass: [0, N, N, N, 3, N, N, N, 5, N, N, N, 3, N, N, N],
    lead: [N, N, 7, N, N, N, N, N, N, N, 10, N, N, N, 7, N],
    bassWave: 'triangle',
    leadWave: 'sine',
  },
  // Contador nervioso: corcheas secas, sin melodia que distraiga la cuenta.
  cuenta: {
    bpm: 140,
    root: 48,
    scale: [0, 2, 4, 7, 9],
    ...
    snare: [4, 12],
    hat: [0, 2, 4, 6, 8, 10, 12, 14],
    bass: [0, N, 0, N, 4, N, 4, N, 2, N, 2, N, 7, N, 7, N],
    lead: [N, N, N, N, N, N, N, N, N, N, N, N, N, N, N, N],
    bassWave: 'square',
    leadWave: 'sine',
  },
  // Sube. La melodia trepa por la escala igual que la torre.
  torre: {
    bpm: 118,
    root: 43,
    scale: [0, 2, 4, 5, 7, 9, 11],
    ...
    snare: [12],
    hat: [2, 6, 10, 14],
    bass: [0, N, N, 2, N, N, 4, N, N, 5, N, N, 7, N, N, N],
    lead: [N, N, 4, N, 5, N, 7, N, 9, N, 11, N, 12, N, N, N],
    bassWave: 'triangle',
    leadWave: 'square',
  },
  // Hipnotico y circular: acompana a la vista mientras persigue el disco.
  trile: {
    bpm: 104,
    root: 45,
    scale: [0, 3, 5, 7, 10],
    ...
    snare: [4, 12],
    hat: [2, 5, 10, 13],
    bass: [0, N, N, 5, N, N, 3, N, N, 7, N, N, 5, N, N, N],
    lead: [7, N, 5, N, 3, N, 5, N, 7, N, 10, N, 7, N, 5, N],
    bassWave: 'sine',
    leadWave: 'triangle',
  },
  // Aguanta, aguanta: un bajo largo y un charles que cuenta los segundos.
  carga: {
    bpm: 96,
    root: 41,
    scale: [0, 2, 3, 7, 8],
    ...
    hat: [0, 4, 8, 12],
    bass: [0, N, N, N, N, N, N, N, 3, N, N, N, N, N, N, N],
    lead: [N, N, N, N, 7, N, N, N, N, N, N, N, 8, N, 7, N],
    bassWave: 'sawtooth',
    leadWave: 'sine',
  },
  // TRAZO y FRENO se quedaron sin tema al entrar y el host prefiere silencio a
  // un tema ajeno, asi que se jugaban mudos. Dos de siete juegos sin musica.
  trazo: {
    bpm: 108,
    root: 47,
    scale: [0, 2, 4, 7, 9],
    ...
    snare: [12],
    hat: [2, 6, 10, 14],
    bass: [0, N, N, N, 4, N, N, N, 2, N, N, N, 7, N, N, N],
    lead: [N, 4, N, 7, N, 9, N, 7, N, 4, N, 2, N, N, N, N],
    bassWave: 'sine',
    leadWave: 'triangle',
  },
  // Corta en seco donde manda la regla: silencios anchos y golpes secos.
  freno: {
    bpm: 126,
    root: 44,
    scale: [0, 1, 5, 7, 8],
    ...
    snare: [4, 12],
    hat: [2, 10],
    bass: [0, N, N, N, N, 5, N, N, 0, N, N, N, N, 7, N, N],
    lead: [N, N, N, N, N, N, N, N, N, N, 8, N, N, N, N, N],
    bassWave: 'square',
    leadWave: 'square',
  },
