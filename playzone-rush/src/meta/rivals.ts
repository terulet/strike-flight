...
export const RIVALS: Rival[] = [
  {
    ...
    name: 'MARC',
    color: '#ff6b6b',
    skill: { reflejos: 0.82, supervivencia: 0.66, precision: 0.74, memoria: 0.6, ritmo: 0.77, trazo: 0.58 },
    consistency: 0.72,
  ...
  },
  {
    ...
    name: 'KALI',
    color: '#22d3ee',
    skill: { reflejos: 0.63, supervivencia: 0.86, precision: 0.58, memoria: 0.71, ritmo: 0.52, trazo: 0.74 },
    consistency: 0.55,
  ...
  },
  {
    ...
    name: 'YOLI',
    color: '#f472b6',
    skill: { reflejos: 0.7, supervivencia: 0.6, precision: 0.83, memoria: 0.88, ritmo: 0.86, trazo: 0.9 },
    consistency: 0.8,
  ...
  },
  {
    ...
    name: 'SILVIA',
    color: '#a3e635',
    skill: { reflejos: 0.58, supervivencia: 0.72, precision: 0.69, memoria: 0.64, ritmo: 0.61, trazo: 0.67 },
    consistency: 0.62,
