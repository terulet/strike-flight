#!/usr/bin/env node
/**
 * Escribe DESENTIERRA.rbxlx: el sitio de Roblox entero, con los tres
 * scripts ya puestos en su servicio y con su nombre y su tipo.
 *
 *   node desenterrar/herramientas/empaquetar.mjs
 *
...
const ajustes = leer("src/ReplicatedStorage/AjustesV2.luau");
const parcela = leer("src/ReplicatedStorage/ParcelaV2.luau");
const servidor = leer("src/ServerScriptService/Desenterrar.server.luau");
const cliente = leer("src/StarterPlayer/StarterPlayerScripts/DesenterrarCliente.client.luau");
...
${guion("ModuleScript", "AjustesV2", ajustes)}
${guion("ModuleScript", "ParcelaV2", parcela)}
  </Item>
  <Item class="ServerScriptService" referent="${ref()}">
    <Properties>
      <string name="Name">ServerScriptService</string>
    </Properties>
${guion("Script", "Desenterrar", servidor)}
  </Item>
...
${guion("LocalScript", "DesenterrarCliente", cliente)}
    </Item>
  </Item>
</roblox>
`;

const destino = join(raiz, "DESENTIERRA.rbxlx");
