...
> Forma parte de **PLAYZONE MAX**, en `max/strike-flight/`. Todas las rutas de
> este documento son relativas a esa carpeta: donde pone `art/naves/kali.png`,
> desde la raíz del proyecto es `max/strike-flight/art/naves/kali.png`.
