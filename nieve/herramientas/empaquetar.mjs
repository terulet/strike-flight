#!/usr/bin/env node
/**
 * Escribe QUITA-LA-NIEVE.rbxlx: el sitio de Roblox entero, con los tres
 * scripts ya puestos en su servicio y con su nombre y su tipo.
 *
 *   node nieve/herramientas/empaquetar.mjs
 *
...
const servidor = leer("src/ServerScriptService/Nieve.server.luau");
const cliente = leer("src/StarterPlayer/StarterPlayerScripts/NieveCliente.client.luau");
...
${guion("ModuleScript", "AjustesNieve", ajustes)}
  </Item>
  <Item class="ServerScriptService" referent="${ref()}">
    <Properties>
      <string name="Name">ServerScriptService</string>
    </Properties>
${guion("Script", "Nieve", servidor)}
  </Item>
...
${guion("LocalScript", "NieveCliente", cliente)}
    </Item>
  </Item>
</roblox>
`;

const destino = join(raiz, "QUITA-LA-NIEVE.rbxlx");
...
const originales = [ajustes, servidor, cliente];
...
console.log(`dentro van los 3 scripts, identicos a los .luau`);
