#!/usr/bin/env node
/**
 * Escribe KALI-SNOW-WORLD-MASTER.rbxmx: los siete scripts en UN solo archivo,
 * para meterlos en un sitio de Roblox que ya exista.
 *
 *   node kali-snow-world/herramientas/empaquetar-modelo.mjs
 *
...
${carpeta(
  "KALI SNOW WORLD MASTER (vacia las 3 carpetas y borrame)",
  [
    carpeta(
...
const destino = join(raiz, "KALI-SNOW-WORLD-MASTER.rbxmx");
