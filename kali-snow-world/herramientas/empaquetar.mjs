#!/usr/bin/env node
/**
 * Escribe KALI-SNOW-WORLD-MASTER.rbxlx: el sitio de Roblox entero, con los tres
 * scripts ya puestos en su servicio y con su nombre y su tipo.
 *
 *   node kali-snow-world/herramientas/empaquetar.mjs
 *
...
${guion("ModuleScript", "Tormenta", tormenta)}
...
const destino = join(raiz, "KALI-SNOW-WORLD-MASTER.rbxlx");
