#!/usr/bin/env node
/**
 * Escribe LA-GRAN-TORMENTA.rbxlx: el sitio de Roblox entero, con los tres
 * scripts ya puestos en su servicio y con su nombre y su tipo.
 *
 *   node la-gran-tormenta/herramientas/empaquetar.mjs
 *
...
const destino = join(raiz, "LA-GRAN-TORMENTA.rbxlx");
