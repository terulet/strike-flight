#!/usr/bin/env node
/**
 * Escribe EL-BARRIO-DESPIERTA.rbxlx: el sitio de Roblox entero, con los tres
 * scripts ya puestos en su servicio y con su nombre y su tipo.
 *
 *   node el-barrio-despierta/herramientas/empaquetar.mjs
 *
...
${guion("ModuleScript", "Mundo", mundo)}
${guion("ModuleScript", "Guardado", guardado)}
...
const destino = join(raiz, "EL-BARRIO-DESPIERTA.rbxlx");
...
const originales = [ajustes, parcela, mundo, guardado, servidor, cliente];
...
console.log(`dentro van los 6 scripts, identicos a los .luau`);
