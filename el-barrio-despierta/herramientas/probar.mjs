 ...
 *
 *   node el-barrio-despierta/herramientas/probar.mjs         las comprobaciones
 *   node el-barrio-despierta/herramientas/probar.mjs medir   cuanto cuesta la puerta
 *
...
const carpeta = mkdtempSync(join(tmpdir(), "barrio-"));
